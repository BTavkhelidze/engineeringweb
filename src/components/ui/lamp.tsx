...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        ' top-10 right-0 left-0 flex min-h-[700px]  overflow-hidden w-full rounded-md z-0',
        className
      )}
    >
      <div className='relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 '>
        ...
        {/* <div className='absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-[#0B1012] blur-2xl'></div> */}
        <div className='absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md'></div>
        <div className='absolute inset-auto z-50 h-36 w-[58rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl'></div>
        <motion.div
          initial={{ width: '8rem' }}
